...
STOCK_SUBCLASS = {
    ...
    "中磊": ('通訊、線材與連接器', '網通 - 寬頻 CPE 與 Wi-Fi 路由器'),
    ...
    "嘉基": ('通訊、線材與連接器', '網通 - 寬頻 CPE 與 Wi-Fi 路由器'),
    ...
    "安瑞-KY": ('通訊、線材與連接器', '網通 - 寬頻 CPE 與 Wi-Fi 路由器'),
    ...
    "建漢": ('通訊、線材與連接器', '網通 - 寬頻 CPE 與 Wi-Fi 路由器'),
    ...
    "正文": ('通訊、線材與連接器', '網通 - 寬頻 CPE 與 Wi-Fi 路由器'),
    ...
    "神準": ('通訊、線材與連接器', '網通 - 寬頻 CPE 與 Wi-Fi 路由器'),
